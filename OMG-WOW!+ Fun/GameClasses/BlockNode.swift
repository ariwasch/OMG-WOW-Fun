...
class BlockNode : SKSpriteNode
{
    ...
    let allStrings6 =  [["DIFFERENT","GREAT","UNIQUE","LIFE","VERY"],["LISTEN","COMMON","WISER","MORE","BETTER","WHEN"],["STARTED","UNTIL","RISE","NARROW","BROADER"],["GOOD","REQUIRES","PEOPLE","DISAGREE","FEAR"],["BECOME","POT","MOSAIC","HOPES","DREAMS","YEARNINGS"],["BELIEVE","STICK","THING","THAT","DRIVING","BIGGEST"]]
    let allStrings1D6 = ["DIFFERENT","GREAT","UNIQUE","LIFE","VERY","LISTEN","COMMON","WISER","MORE","BETTER","WHEN","STARTED","UNTIL","RISE","NARROW","BROADER","GOOD","REQUIRES","PEOPLE","DISAGREE","FEAR","BECOME","POT","MOSAIC","HOPES","DREAMS","YEARNINGS","BELIEVE","STICK","THING","THAT","DRIVING","BIGGEST"]
